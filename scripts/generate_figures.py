...
def research_design(rows):
    output = [
        ...
        text(
            55,
            80,
            "Static degree-targeted removal versus 200 seeded same-count random removals",
            15,
            "400",
            "start",
            SOFT,
    ...
    output.extend(
        [
            ...
            text(980, 200, "Random mean", 12.5, "700"),
            f'<rect x="925" y="222" width="40" height="16" fill="{BAND}" fill-opacity="0.7"/>',
            text(980, 235, "Random p05–p95", 12.5, "700"),
            ...
            text(925, 462, "Random mean", 12, "600", "start", "#7c2d12"),
            text(925, 485, "0.9912", 24, "700", "start", RANDOM),
            text(925, 520, "Gap = 0.1304", 14, "700", "start", "#7c2d12"),
            text(925, 550, "Targeted stays below random p05", 11.5, "600", "start", "#7c2d12"),
            text(925, 570, "at all five released stress levels.", 11.5, "600", "start", "#7c2d12"),
            text(55, 704, "The blue band is an empirical random-comparator band, not a confidence interval. Email connectivity is a structural proxy for potential information access.", 12, "400", "start", GRAY),
            "</svg>",
        ]
    )
...
def method():
    output = [
        ...
        text(
            55,
            80,
            "Source hypergraph → simple projection → stress test → random comparator → bounded L&D interpretation",
            15,
            "400",
            "start",
            SOFT,
        ...
        box(505, 335, 225, 135, "6 • Random benchmark", ["200 same-count draws", "Seed 20260925", "Mean + p05 / p95"], "#eff6ff", "#3b82f6", "#1d4ed8"),
        ...
        text(55, 700, "Key safeguard: the targeted rule is static degree loss, the random band is descriptive, and the network is a communication proxy rather than a knowledge measure.", 13, "700", "start", "#334155"),
        "</svg>",
    ]
    return "".join(output)
...
def architecture():
    output = [
        ...
        text(85, 420, "Random mean", 13, "700", "start", RANDOM),
        text(235, 420, "0.9973 → 0.9912", 13, "600"),
        text(85, 454, "Gap", 13, "700", "start", GOLD),
        text(235, 454, "0.0238 → 0.1304", 13, "600"),
...
def evaluation():
    output = [
        ...
        box(55, 220, 1090, 96, "Stress-test finding", ["Targeted retained efficiency falls 0.9735 → 0.8608 while the random mean remains close to baseline."], "#f0fdf4", "#22c55e", "#15803d"),
        box(55, 340, 1090, 96, "Comparator evidence", ["Targeted is below random p05 at every k; targeted-versus-random mean gap widens 0.0238 → 0.1304."], "#fff7ed", "#f59e0b", "#92400e"),
