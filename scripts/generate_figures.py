...
def evaluation():
    output = [
        ...
        box(55, 340, 1090, 96, "Comparator evidence", ["Targeted is below random p05 at every k; targeted-versus-random mean gap widens 0.0243 → 0.1309."], "#fff7ed", "#f59e0b", "#92400e"),
