...
7. constructs 200 version-stable deterministic pseudo-random comparators at every k using SHA-256 ranking over seed, removal level, draw index, and node ID;
