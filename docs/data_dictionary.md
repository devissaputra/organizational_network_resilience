...
- `random_mean`: mean retained efficiency across 200 version-stable deterministic pseudo-random same-count comparator draws generated by SHA-256 ranking over seed, removal level, draw index, and node ID;
